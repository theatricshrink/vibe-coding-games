...
self.addEventListener('fetch', function(e) {
  ...
  // directly. Intercepting navigations can cause ERR_FAILED when the cache
  // is cold or the network is unavailable, breaking portal→game navigation.
