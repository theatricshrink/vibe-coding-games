var STRINGS = {
  en: {
    ...
    decodeChoiceHint: 'TAP THE MATCHING LETTER',
    decodeFreeHint: '⬆ DIFFICULTY INCREASE — TYPE YOUR ANSWER',
    ...
    encodeInstruction: 'TAP DOT &amp; DASH TO ENCODE',
    encodeDot: '·  DOT',
    encodeDash: '—  DASH',
    encodeHint: 'PAUSE TO CONFIRM · USE REF IF UNSURE',
    // Stars
  ...
  de: {
    ...
    decodeChoiceHint: 'PASSENDEN BUCHSTABEN TIPPEN',
    decodeFreeHint: '⬆ SCHWIERIGKEITSANSTIEG — ANTWORT EINTIPPEN',
    ...
    encodeInstruction: 'PUNKT &amp; STRICH TIPPEN ZUM CODIEREN',
    encodeDot: '·  PUNKT',
    encodeDash: '—  STRICH',
    encodeHint: 'PAUSE ZUM BESTÄTIGEN · BEI UNKLARHEIT REF NUTZEN',
